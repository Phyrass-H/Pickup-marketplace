...
- **Driver app redesign (still the headline next):** the Driver app inherits the navy palette but its
  **layout** isn't redesigned yet. Either the founder hands a phone mockup (Claude Design zip) or we use the
  D25 inline-mockup loop to design it, then implement.
